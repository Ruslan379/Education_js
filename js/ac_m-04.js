...
// console.log(getUsersWithEyeColor(users, "brown1"));
...
// console.log(getUserWithEmail(users, "blackburndotson@furnigeer1.com"));
...
// // //! 2-й вариант
// // const isEveryUserActive = (users) => {
// //   const usersIsActive = users.every(user => user.isActive);
// //   console.log(usersIsActive);
// //   return usersIsActive;
// // };
...
// //! 1-й вариант ПОНЯТНЫЙ, но НЕ ПРИНИМАЕТ согласно ТЗ
// // // const names = books;
// // const f = books.filter(book => book.rating >= MIN_BOOK_RATING);
// // console.log(f);
// // const m = f.map(book => book.author);
// // console.log(m);
// // const s = m.sort((a, b) => a.localeCompare(b));
// // console.log(s);
// // const names = s;
// // console.log(names);
...
// //   const s = [...users].sort((a, b) => (a.friends).length - (b.friends).length);
// //   // console.log(s);
// //   const m = s.map(user => user.name);
// //   // console.log(m);
// //   return m
// // };
...
// //   const fm = users.flatMap(user => user.friends);
// //   // console.log(fm);
// //   const f = fm.filter(
// //   (course, index, array) => array.indexOf(course) === index
// //   );
// //   // console.log(f);
// //   const s = [...f].sort((a, b) => a.localeCompare(b));
// //   // console.log(s);
...
// //! 2-й вариант - ПРИНЯТ!!!
// const getSortedFriends = users => {
//   return [...((users.flatMap(user => user.friends)).filter((course, index, array) => array.indexOf(course) === index))].sort((a, b) => a.localeCompare(b));
// };
